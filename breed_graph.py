...
class BreedGraph:
  ...
  def find_path_to_each_relevant_pokemon(self, input_pokemons):
    ...
    """
    Logger.log_current_step("Finding which pokemons will be included in the final graph")
    ...
    Logger.log_current_step("Calculating path to each relevant pokemon")
  ...
  def draw_graph_from_paths(self, input_pokemons, paths_to_pokemons, ax=None):
    Logger.log_current_step("Drawing figure")
